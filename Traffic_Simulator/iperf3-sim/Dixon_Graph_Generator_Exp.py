...
def populate_data(file_path, data_dict):
    ...
    try:
        ...
        headers = [data_dict["x_axis"], data_dict["first_header"], data_dict["sec_header"]]
        data = [data_dict["x_axis_value"], data_dict["first_header_value"], data_dict["sec_header_value"]]
        ...
        data_range = sheet.range((1, 1), (len(data_dict["x_axis_value"]) + 1, len(headers)))
